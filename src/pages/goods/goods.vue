...
<template>
  <scroll-view v-if="isShow" scroll-y class="viewport">
    <!-- 基本信息 -->
    <view class="goods">
      <!-- 商品主图 -->
      <view class="preview">
        <swiper @change="onChange" circular autoplay :interval="3000" class="swiper">
  ...
  <view class="toolbar" :style="{ paddingBottom: safeAreaInsets?.bottom + 'px' }">
    <view class="icons">
      <button class="icons-button"><text class="icon-heart">
        
      </text>
      <image
          src="../../static/svgs/collect.svg"
          mode="scaleToFill"
